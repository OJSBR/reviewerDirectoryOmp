...
- Include your **OMP version**, the **plugin version** (see `version.xml`), and steps
...
- Informe a **versão do OMP**, a **versão do plugin** (veja `version.xml`) e o passo a
...
`stable-3_5_0` (OMP 3.5.x). **Baseie seu trabalho — e abra o pull request — nessa branch.**
